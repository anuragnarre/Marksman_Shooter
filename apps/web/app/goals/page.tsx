    ...
    <AppShell title="Goals">
      <div className="space-y-6 max-w-5xl">
        ...
        <div className="animate-slide-up flex flex-col sm:flex-row sm:items-end justify-between gap-4">
          <div>
            <h1 className="font-display font-bold text-2xl text-[#F0F4FF]">Goals & Records</h1>
          ...
          <>
                ...
                {!pbs ? (
                  ...
                  <>
                    ...
                    <div className="card p-5">
                      <h3 className="font-display font-semibold text-sm text-[#F0F4FF] mb-4">Lifetime Stats</h3>
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    ...
                    {Object.keys(pbs.byDisc).length > 0 && (
                      <div className="card p-5">
                        <h3 className="font-display font-semibold text-sm text-[#F0F4FF] mb-4">Best by Discipline</h3>
            ...
            {tab === 'milestones' && (
              <div className="space-y-4 animate-slide-up">
                ...
                {earned.length > 0 && (
                  <p className="text-center text-[#4A5568] text-xs font-display pt-2">
  ...
  const inner = (
    ...
    >
      ...
      <div className="flex items-start justify-between mb-2">
        ...
        {href && (
          <span className="text-[10px] font-display text-[#4A5568] hover:text-[#F5A623] transition-colors">
            View →
          </span>
        )}
      </div>
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <p className="text-sm font-display font-semibold text-[#F0F4FF] truncate">{discipline}</p>
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 mb-4">
        ...
        <p className="font-display font-bold text-sm text-[#F0F4FF]">New Goal</p>
      </div>
      ...
      <div className="flex items-start justify-between mb-4">
        <div>
          <div className="flex items-center gap-2">
            <p className="font-display font-bold text-sm text-[#F0F4FF]">{goal.discipline}</p>
            {allDone && (
        ...
        <div>
          {confirming ? (
            <div className="flex gap-2 items-center">
              <span className="text-[10px] text-[#4A5568]">Remove?</span>
              ...
              <button onClick={() => setConfirming(false)}
                className="text-[10px] font-display font-bold px-2 py-1 rounded text-[#4A5568] hover:text-[#F0F4FF] transition-colors">
                No
              </button>
            </div>
          ) : (
            <button
              ...
              className="text-[#4A5568] hover:text-[#FF4D6D] transition-colors text-xs"
            >
              ✕
            </button>
          )}
