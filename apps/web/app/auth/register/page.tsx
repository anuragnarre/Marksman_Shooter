...
function RegisterPageInner() {
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-h-0 overflow-y-auto px-6 pt-6 pb-10 lg:pt-10 lg:flex lg:items-center lg:justify-center">
...
function RangeIcon() {
  return (
    <svg width="28" height="28" viewBox="0 0 28 28" fill="none" stroke="currentColor"
      strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M4 22L4 12L14 4L24 12L24 22" />
      <path d="M10 22L10 16L18 16L18 22" />
    </svg>
  );
}
