// apps/web/app/guidance/page.tsx
'use client';
    ...
    <AppShell title="Guidance">
      ...
      <section className="relative mb-10 overflow-hidden rounded-2xl" style={{ minHeight: 280 }}>
        ...
        <div
          ...
          style={{
            background:
              'linear-gradient(135deg, rgba(6,8,16,0.85) 0%, rgba(6,8,16,0.5) 50%, rgba(6,8,16,0.85) 100%)',
          }}
        />
        {/* Amber accent line */}
        <div
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center px-6 py-16 sm:py-20">
          ...
          <h1
            ...
            style={{
              background: 'linear-gradient(135deg, #F0F4FF 0%, #F5A623 50%, #F0F4FF 100%)',
          ...
          <p className="text-[#8892A4] text-sm sm:text-base max-w-xl leading-relaxed">
        ...
        {SECTIONS.map((s) => (
          <button
            ...
            style={{
              ...
              color: activeSection === s.id ? s.color : '#8892A4',
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-6">
        ...
        >
          <div className="relative h-52 sm:h-64 overflow-hidden">
            ...
            <div
              className="absolute inset-0"
              style={{ background: 'linear-gradient(0deg, rgba(12,15,26,1) 0%, transparent 60%)' }}
            />
            <div className="absolute bottom-4 left-5 right-5">
              <span className="tag">Fundamental</span>
              <h3 className="font-display font-bold text-lg text-[#F0F4FF] mt-2">
          ...
          <div className="p-5 space-y-3">
            ...
            <p className="prose-p">
              <strong className="text-[#F0F4FF]">Sight picture</strong> combines sight alignment with
      ...
      >
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h3 className="font-display font-bold text-[#F0F4FF] text-base">Marksmanship Fundamentals</h3>
            <p className="text-[#4A5568] text-xs">Understanding the core principles of precision shooting</p>
          </div>
        </div>
      ...
      >
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h3 className="font-display font-bold text-[#F0F4FF] text-base">Shooting Positions Masterclass</h3>
            <p className="text-[#4A5568] text-xs">Detailed breakdown of standing, kneeling, sitting, and prone</p>
          </div>
        </div>
        <div className="relative rounded-xl overflow-hidden" style={{ aspectRatio: '16/9' }}>
          <iframe
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-5 mb-6">
        ...
        >
          <h3 className="font-display font-bold text-[#F0F4FF] text-base mb-4">The Respiratory Pause</h3>
          <div className="relative overflow-hidden rounded-xl mb-5" style={{ height: 180 }}>
            <img
              ...
              loading="lazy"
            />
            <div className="absolute inset-0" style={{ background: 'rgba(12,15,26,0.5)' }} />
        ...
        >
          <div className="card p-5">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h4 className="font-display font-bold text-sm text-[#F0F4FF]">Do</h4>
            </div>
            <ul className="space-y-2">
              {[
                ...
                <li key={t} className="flex gap-2.5 text-[#8892A4] text-[13px] leading-relaxed">
          ...
          <div className="card p-5">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h4 className="font-display font-bold text-sm text-[#F0F4FF]">Avoid</h4>
            </div>
            <ul className="space-y-2">
              {[
      ...
      >
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h3 className="font-display font-bold text-[#F0F4FF] text-base">Breathing Technique for Precision Shooters</h3>
            <p className="text-[#4A5568] text-xs">Learn the respiratory pause and timing your shot</p>
          </div>
        </div>
        <div className="relative rounded-xl overflow-hidden" style={{ aspectRatio: '16/9' }}>
          <iframe
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-6">
        ...
        >
          <h3 className="font-display font-bold text-[#F0F4FF] text-lg mb-4">Trigger Control</h3>
          <div className="relative rounded-xl overflow-hidden mb-5 h-48">
            <img
              ...
              loading="lazy"
            />
            <div className="absolute inset-0" style={{ background: 'linear-gradient(0deg, rgba(12,15,26,0.9) 0%, transparent 70%)' }} />
          </div>
        ...
        >
          <h3 className="font-display font-bold text-[#F0F4FF] text-lg mb-4">Common Trigger Errors</h3>
      ...
      >
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h3 className="font-display font-bold text-[#F0F4FF] text-base">Mastering Trigger Control</h3>
            <p className="text-[#4A5568] text-xs">Techniques for a clean, consistent trigger press</p>
          </div>
        </div>
        <div className="relative rounded-xl overflow-hidden" style={{ aspectRatio: '16/9' }}>
          <iframe
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-6">
        ...
        >
          <div className="card p-5">
            <h4 className="font-display font-bold text-sm text-[#F0F4FF] mb-3">Pre-Shot Routine</h4>
            <p className="prose-p mb-3">
            ...
            <div className="space-y-2">
              {[
                ...
                <div key={i} className="flex items-start gap-3">
                  ...
                  <span className="text-[#8892A4] text-[13px] leading-relaxed">{step}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="card p-5">
            <h4 className="font-display font-bold text-sm text-[#F0F4FF] mb-3">Shot Calling</h4>
            <p className="prose-p">
      ...
      >
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h3 className="font-display font-bold text-[#F0F4FF] text-base">Mental Game in Competitive Shooting</h3>
            <p className="text-[#4A5568] text-xs">Developing focus, confidence, and composure under pressure</p>
          </div>
        </div>
        <div className="relative rounded-xl overflow-hidden" style={{ aspectRatio: '16/9' }}>
          <iframe
      ...
      >
        <div className="relative rounded-xl overflow-hidden mb-6 h-52">
          <img
            ...
            loading="lazy"
          />
          <div className="absolute inset-0" style={{ background: 'linear-gradient(0deg, rgba(12,15,26,0.95) 0%, rgba(12,15,26,0.3) 100%)' }} />
          <div className="absolute bottom-5 left-5 right-5">
            <h3 className="font-display font-black text-2xl text-[#F0F4FF]">The 4 Universal Rules</h3>
            <p className="text-[#8892A4] text-sm mt-1">These rules apply to every firearm, every time, without exception.</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-6">
        ...
        >
          <h4 className="font-display font-bold text-sm text-[#F0F4FF] mb-3">Required Protective Equipment</h4>
          <div className="space-y-3">
            {[
              ...
              <div key={item.name} className="flex items-start gap-3 p-3 rounded-xl" style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.04)' }}>
                ...
                <div>
                  <p className="font-display font-bold text-[13px] text-[#F0F4FF]">{item.name}</p>
                  <p className="text-[#8892A4] text-[12px] leading-relaxed">{item.desc}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        >
          <h4 className="font-display font-bold text-sm text-[#F0F4FF] mb-3">Range Commands & Etiquette</h4>
          <div className="space-y-2.5">
            {[
              ...
              <div key={item.cmd} className="p-3 rounded-xl" style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.04)' }}>
                <span className="font-display font-bold text-[13px]" style={{ color: '#F59E0B' }}>{item.cmd}</span>
                <p className="text-[#8892A4] text-[12px] leading-relaxed mt-0.5">{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      >
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h3 className="font-display font-bold text-[#F0F4FF] text-base">Range Safety Essentials</h3>
            <p className="text-[#4A5568] text-xs">Safety protocols every shooter must know before stepping on the range</p>
          </div>
        </div>
        <div className="relative rounded-xl overflow-hidden" style={{ aspectRatio: '16/9' }}>
          <iframe
      ...
      >
        <p className="text-[#4A5568] text-xs uppercase tracking-widest font-display font-bold mb-3">
          Ready to Apply What You've Learned?
        </p>
        <h2 className="font-display font-black text-2xl text-[#F0F4FF] mb-2">
          Start a Training Session
        </h2>
        <p className="text-[#8892A4] text-sm max-w-md mx-auto mb-6">
...
function SectionHeader({ id, section, visible }: { id: string; section: GuidanceSection; visible: boolean }) {
  return (
    <div
      id={id}
      data-reveal
    ...
    >
      ...
      <div>
        <h2 className="font-display font-bold text-xl text-[#F0F4FF] leading-tight">{section.title}</h2>
        <p className="text-[#4A5568] text-xs mt-0.5">{section.subtitle}</p>
      </div>
    ...
    >
      <div className="relative h-44 overflow-hidden">
        <img
          ...
          loading="lazy"
        />
        <div className="absolute inset-0" style={{ background: 'linear-gradient(0deg, rgba(12,15,26,1) 0%, transparent 70%)' }} />
        <div className="absolute bottom-3 left-4 right-4 flex items-end justify-between">
          <h4 className="font-display font-bold text-[#F0F4FF]">{title}</h4>
          <span
      ...
      <div className="p-4">
        <ul className="space-y-2">
          {points.map((p, i) => (
            <li key={i} className="flex gap-2.5 text-[#8892A4] text-[12px] leading-relaxed">
...
function StepItem({ n, text, color }: { n: number; text: string; color: string }) {
  return (
    <div className="flex items-start gap-3">
      ...
      <p className="text-[#8892A4] text-[13px] leading-relaxed">{text}</p>
    </div>
  );
}
...
function TriggerStep({ title, desc, color }: { title: string; desc: string; color: string }) {
  return (
    ...
    >
      ...
      <p className="text-[#8892A4] text-[12px] leading-relaxed">{desc}</p>
    </div>
  );
}
  ...
  return (
    <div className="p-4 rounded-xl" style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)' }}>
      <div className="flex items-center justify-between mb-2">
        <h5 className="font-display font-bold text-[14px] text-[#F0F4FF]">{title}</h5>
        <span
          className="text-[10px] font-display font-bold uppercase tracking-wider px-2 py-0.5 rounded-md"
...
function MentalStat({ label, value, icon }: { label: string; value: string; icon: React.ReactNode }) {
  return (
    <div className="p-3 rounded-xl text-center" style={{ background: 'rgba(167,139,250,0.05)', border: '1px solid rgba(167,139,250,0.12)' }}>
      ...
      <p className="font-display font-bold text-[12px] text-[#F0F4FF] leading-tight">{value}</p>
      <p className="text-[#4A5568] text-[10px] mt-0.5">{label}</p>
    </div>
  );
}
...
function SafetyRule({ n, title, desc, color }: { n: number; title: string; desc: string; color: string }) {
  return (
    <div className="p-4 rounded-xl" style={{ background: `${color}06`, border: `1px solid ${color}18` }}>
      ...
      <p className="text-[#8892A4] text-[12px] leading-relaxed ml-11">{desc}</p>
    </div>
  );
}
...
function BreathingDiagram() {
  return (
    <svg width="280" height="80" viewBox="0 0 280 80" fill="none" className="drop-shadow-lg">
      ...
      {/* Labels */}
      <text x="70" y="76" textAnchor="middle" fill="#4A5568" fontSize="8" fontFamily="Rajdhani, sans-serif">
        Inhale / Exhale
      </text>
      <text x="240" y="76" textAnchor="middle" fill="#4A5568" fontSize="8" fontFamily="Rajdhani, sans-serif">
        Inhale / Exhale
      </text>
    </svg>
  );
